    ...
    <>
      ...
      <section className="py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h2 className="text-2xl font-bold text-foreground sm:text-3xl">Everything You Need for the Open Road</h2>
            <p className="mt-4 text-base text-muted-foreground sm:text-lg">Powerful tools to plan, track, and share your road trips.</p>
          </div>
          <div className="mt-12 grid gap-6 sm:mt-16 sm:gap-8 md:grid-cols-3">
            {[
              ...
              <div key={feature.title} className="rounded-xl border border-border bg-card p-6 transition-shadow hover:shadow-lg sm:p-8">
      ...
      <section className="bg-primary py-16">
        <div className="mx-auto max-w-7xl px-4 text-center sm:px-6 lg:px-8">
          <h2 className="text-2xl font-bold text-white sm:text-3xl">Ready to Hit the Road?</h2>
          <p className="mt-4 text-base text-white/80 sm:text-lg">Join thousands of travelers planning their next adventure.</p>
          <Link
            href="/register"
